!(function (n) {
    ...
    rules: function (t, i) {
      if (this.length) {
        ...
        return (
          ...
          u.remote &&
            ((o = u.remote), delete u.remote, (u = n.extend(u, { remote: o }))),
          u
        );
      }
    },
  ...
  n.extend(n.validator, {
    ...
    prototype: {
      ...
      addWrapper: function (n) {
        return (
          this.settings.wrapper && (n = n.add(n.parent(this.settings.wrapper))),
          n
        );
      },
                    ...
                    success: function (n) {
                      ...
                      o
                        ...
                        : ((r = {}),
                          (s =
                            n ||
                            f.defaultMessage(i, { method: u, parameters: t })),
  ...
  (function (n) {
    ...
    function c(t, i) {
      ...
      r.removeClass("field-validation-valid").addClass(
    ...
    t.add = function (n, t, i) {
      return (
        i || ((i = t), (t = [])),
        this.push({ name: n, params: t, adapt: i }),
        this
      );
    };
    ...
    r.methods.extension
      ? (t.addSingleVal("accept", "mimtype"),
        t.addSingleVal("extension", "extension"))
      : t.addSingleVal("extension", "extension", "accept");
    t.addSingleVal("regex", "pattern");
    t.addBool("creditcard")
      .addBool("date")
      .addBool("digits")
      .addBool("email")
      .addBool("number")
      .addBool("url");
    t.addMinMax("length", "minlength", "maxlength", "rangelength").addMinMax(
      "range",
      "min",
      "max",
      "range"
    );
    t.addMinMax("minlength", "minlength").addMinMax(
      "maxlength",
      "minlength",
      "maxlength"
    );
