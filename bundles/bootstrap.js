  ...
  (function (n) {
    ...
    if (
      ...
      (t.mediaQueriesSupported =
        n.matchMedia &&
        null !== n.matchMedia("only all") &&
        n.matchMedia("only all").matches),
      !t.mediaQueriesSupported)
    ) {
      var c,
        b,
        ...
        y = function (t) {
          var rt = "clientWidth",
            ...
            it;
          if (t && c && k > et - c)
            return n.clearTimeout(b), (b = n.setTimeout(y, k)), void 0;
          c = et;
          for (tt in e)
            if (e.hasOwnProperty(tt)) {
              ...
              (a.hasquery &&
                ((ot && st) || !(ot || ft >= w) || !(st || d >= ft))) ||
                (p[a.media] || (p[a.media] = []), p[a.media].push(o[a.rules]));
            }
          for (g in u)
            u.hasOwnProperty(g) &&
              u[g] &&
          ...
          for (nt in p)
            p.hasOwnProperty(nt) &&
              ...
              f.styleSheet
                ? (f.styleSheet.cssText = it)
                : f.appendChild(i.createTextNode(it)),
              u.push(f));
        },
        d = function (n, i, r) {
          ...
          for (
            ...
            for (
              a
                ? ((v = r), o.push(l(n)))
                : ((v = h[f].match(t.regex.findStyles) && RegExp.$1),
              ...
              (u = p[s]),
                e.push({
                  media:
                    (u.split("(")[0].match(t.regex.only) && RegExp.$2) || "all",
                  rules: o.length - 1,
                  hasquery: u.indexOf("(") > -1,
                  minw:
                    u.match(t.regex.minw) &&
                    parseFloat(RegExp.$1) + (RegExp.$2 || ""),
                  maxw:
                    u.match(t.regex.maxw) &&
                    parseFloat(RegExp.$1) + (RegExp.$2 || ""),
                });
          y();
        },
        ...
        nt = function () {
          for (var r = 0; r < h.length; r++) {
            ...
            t &&
              e &&
              !a[t] &&
              (i.styleSheet && i.styleSheet.rawCssText
                ? (d(i.styleSheet.rawCssText, t, u), (a[t] = !0))
                : ((!/^([a-zA-Z:]*\/\/)/.test(t) && !it) ||
                    t.replace(RegExp.$1, "").split("/")[0] ===
                      n.location.host) &&
                  ("//" === t.substring(0, 2) && (t = n.location.protocol + t),
                  f.push({ href: t, media: u })));
          }
          g();
        };
      nt();
      ...
      t.getEmValue = v;
      n.addEventListener
        ? n.addEventListener("resize", p, !1)
        : n.attachEvent && n.attachEvent("onresize", p);
    }
  })(this);
