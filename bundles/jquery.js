!(function (n, t) {
  ...
  function le(n, t, u) {
    ...
    for (f in t)
      if (((a = t[f]), vu.exec(a))) {
        if (
          (delete t[f], (p = p || "toggle" === a), a === (c ? "hide" : "show"))
        ) {
    ...
    if (i.isEmptyObject(y))
      "inline" === ("none" === h ? oi(n.nodeName) : h) && (s.display = h);
    else {
  ...
  i.fn.extend({
    ...
    is: function (n) {
      return !!ri(this, "string" == typeof n && ir.test(n) ? i(n) : n || [], !1)
        .length;
    },
  });
  fr = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/;
            ...
            function (t) {
              ...
              if (u && void 0 === t) {
                if (
                  ((r =
                    e.get(u, n) ||
                    e.get(u, n.replace(cr, "-$&").toLowerCase())),
                  void 0 !== r) ||
    ...
    i.cssHooks[t] = {
      ...
      set: function (n, r, u) {
        var f,
          e = u && bt(n),
          o =
            u && cu(n, t, u, "border-box" === i.css(n, "boxSizing", !1, e), e);
        return (
          o &&
            (f = ot.exec(r)) &&
            "px" !== (f[3] || "px") &&
      ...
      if (3 !== e && 8 !== e && 2 !== e)
        return "undefined" == typeof n.getAttribute
          ...
          : ((1 === e && i.isXMLDoc(n)) ||
              ((t = t.toLowerCase()),
              (f =
                i.attrHooks[t] || (i.expr.match.bool.test(t) ? bu : void 0))),
            void 0 !== r
              ? null === r
      ...
      return arguments.length
        ...
        ? ((t = i.valHooks[u.type] || i.valHooks[u.nodeName.toLowerCase()]),
          t && "get" in t && void 0 !== (r = t.get(u, "value"))
            ? r
            : ((r = u.value),
              "string" == typeof r ? r.replace(gu, "") : null == r ? "" : r))
        : void 0;
    },
  });
  i.extend({
    ...
    ajax: function (t, r) {
      ...
      if (
        ...
        try {
          ...
          l.href = l.href;
          f.crossDomain =
            pi.protocol + "//" + pi.host != l.protocol + "//" + l.host;
        } catch (ft) {
          f.crossDomain = !0;
        }
      }
      ...
      if (f.beforeSend && (f.beforeSend.call(c, e, f) === !1 || 2 === s))
        return e.abort();
      ut = "abort";
      for (a in { success: 1, error: 1, complete: 1 }) e[a](f[a]);
      if ((v = ef(yi, f, r, e))) {
        if (((e.readyState = 1), y && g.trigger("ajaxSend", [e, f]), 2 === s))
          return e;
        f.async &&
          f.timeout > 0 &&
  ...
  (function (n) {
    ...
    function f(t, r) {
      var e, h, f, c;
      ((e = t.getAttribute("data-ajax-confirm")), !e || window.confirm(e)) &&
        ((h = n(t.getAttribute("data-ajax-loading"))),
  ...
  (function (n, t, i, r) {
    ...
    i.extend(u, {
      ...
      helpers: {},
      open: function (n, t) {
        if (n && (i.isPlainObject(t) || (t = {}), !1 !== u.close(!0)))
          return (
            ...
            i.each(n, function (f, e) {
              ...
              !o &&
                ...
                o ||
                  (o = (o = e.prop("class").match(/fancybox\.(\w+)/))
                    ? o[1]
                    : null));
              c(s) &&
                (o ||
                  (u.isImage(s)
                    ...
                    : c(e) && ((o = "html"), (l = e))),
                "ajax" === o &&
                  ((v = s.split(/\s+/, 2)), (s = v.shift()), (v = v.shift())));
              l ||
                ("inline" === o
                  ? s
      ...
      jumpto: function (n, t, i) {
        ...
        e &&
          ...
          (u.router = i || "jumpto"),
          e.loop &&
            (0 > n && (n = e.group.length + (n % e.group.length)),
            (n %= e.group.length)),
          ...
          (v = setTimeout(
            function () {
              ...
              r &&
                ...
                (i || "load" === t || ("resize" === t && r.autoResize)) &&
                  u._setDimension(),
      ...
      toggle: function (n) {
        u.isOpen &&
          ((u.current.fitToView =
            "boolean" === i.type(n) ? n : !u.current.fitToView),
          s &&
          ...
          i.fn.mousewheel &&
            ...
            u.wrap.bind("mousewheel.fb", function (t, r, f, e) {
              ...
              0 !== r &&
                ...
                !n.canShrink &&
                (0 < e || 0 < f
                  ? u.prev(0 < e ? "down" : "left")
                  : (0 > e || 0 > f) && u.next(0 > e ? "up" : "right"),
                t.preventDefault());
            }));
      },
      trigger: function (n, t) {
      ...
      _afterLoad: function () {
        ...
        if ((u.hideLoading(), n && !1 !== u.isActive))
          if (!1 === u.trigger("afterLoad", n, r))
            n.wrap.stop(!0).trigger("onReset").remove(), (u.coming = null);
          else {
            r &&
              (u.trigger("beforeChange", r),
              r.wrap
                .stop(!0)
            ...
            switch (s) {
              ...
              case "html":
                n.selector
                  ? (t = i("<div>").html(t).find(n.selector))
                  : a(t) &&
            ...
            u.bindEvents();
            u.isOpened
              ? r.prevMethod && u.transitions[r.prevMethod]()
              : i(".fancybox-wrap")
                  .not(n.wrap)
                  .stop(!0)
                  .trigger("onReset")
      ...
      _setDimension: function () {
        ...
        if (
          ...
          if (((ut = r.content), r.autoHeight && 1 === ut.data("ready")))
            try {
              ut[0].contentWindow.document.location &&
                (e.width(d).height(9999),
        ...
        if (
          ...
          (ot = y),
          r.fitToView &&
            ((v = Math.min(o.w - b, v)), (y = Math.min(o.h - rt, y))),
          (b = o.w - w),
          (tt = o.h - tt),
          r.aspectRatio
            ? (n > v && ((n = v), (t = f(n / g))),
      ...
      _getPosition: function (n) {
        var i = u.current,
          ...
          t = { position: "absolute", top: t[0], left: t[3] };
        return (
          i.autoCenter && i.fixed && !n && e <= r.h && f <= r.w
            ? (t.position = "fixed")
      ...
      _afterZoomIn: function () {
        ...
        n &&
          ...
          u.update(),
          (n.closeClick || (n.nextClick && 1 < u.group.length)) &&
    ...
    u.transitions = {
      getOrigPosition: function () {
        ...
        return (
          ...
          ("fixed" === u.wrap.css("position") || n.locked) &&
      ...
      step: function (n, t) {
        ...
        s = i.skinSpace;
        ("width" === r || "height" === r) &&
          ((e = t.end === t.start ? 1 : (n - t.start) / (t.end - t.start)),
          u.isClosing && (e = 1 - e),
      ...
      changeIn: function () {
        ...
        t.opacity = 0.1;
        "elastic" === o &&
          ((n = "down" === r || "up" === r ? "top" : "left"),
          "down" === r || "right" === r
            ? ((t[n] = h(f(t[n]) - 200)), (e[n] = "+=200px"))
            : ((t[n] = h(f(t[n]) + 200)), (e[n] = "-=200px")));
        "none" === o
          ? u._afterZoomIn()
          : u.wrap
    ...
    u.helpers.overlay = {
      ...
      create: function (n) {
        ...
        this.overlay = i('<div class="fancybox-overlay"></div>').appendTo(
          u.coming ? u.coming.parent : n.parent
        );
        this.fixed = !1;
        n.fixed &&
          u.defaults.fixed &&
    ...
    u.helpers.title = {
      ...
      beforeShow: function (n) {
        var t = u.current,
          ...
          r = n.type;
        if (
          (i.isFunction(e) && (e = e.call(t.element, t)),
          c(e) && "" !== i.trim(e))
        ) {
          t = i(
    ...
    o.ready(function () {
      ...
      i.support.fixedPosition === r &&
        ((f = i.support),
        (t = i('<div style="position:fixed;top:20px;"></div>').appendTo(
          "body"
        )),
      ...
      n.widget("zpd.paging", {
        ...
        _getNavBar: function () {
          for (
            var r = this.options.rows,
              t = n("<ul>", { class: "pagination" }),
              i = 0;
            i < Math.ceil(r.length / this.options.limit);
            i++
          )
            this._on(
              n(
          ...
          return (
            this._on(
              n(
                '<li><a href="#" data-direction="-1"><span aria-hidden="true">&laquo;</span></a></li>'
              ).prependTo(t),
              { click: "pageStepHandler" }
            ),
            this._on(
              n(
                '<li><a href="#" data-direction="1"><span aria-hidden="true">&raquo;</span></a></li>'
              ).appendTo(t),
              { click: "pageStepHandler" }
            ),
            t
        ...
        showPage: function (t) {
          var u = t * 1,
            ...
            i;
          for (
            this.options.activePage = u,
              r = this.options.rows,
              f = this.options.limit,
              i = 0;
            i < r.length;
            i++
          )
            i >= f * u && i < f * (u + 1)
              ? n(r[i]).css("display", this.options.rowDisplayStyle)
              : n(r[i]).css("display", "none");
        },
        ...
        pageStepHandler: function (t) {
          ...
          i >= 0 &&
            i < this.options.rows.length &&
            n(
              "a[data-page=" + i + "]",
              n(t.target).parent().parent().parent()
            ).click();
        },
      });
    });
